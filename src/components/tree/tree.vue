...
<template>
  <ul ref="tree" :class="['root-tree', , {'is-multi-root': multiRoot}]">
    <root-tree-item :class="[$options.itemClass, $options.rootClass]"
      :is-root="true"
      v-bind="vRootData"
      :key="vRootData.key"
      v-on="$listeners"
  ...
  export default {
    ...
    props: {
      ...
      /**
        ...
        array: [
          {key: foo, parentKey: null, folded: false, rank: 0, options null }
        ]
      */
      dataType: {
        default () {
